...
export const PONTOS_RAPIDA: Record<Vista, PontoAnatomico[]> = {
  anterior: [
    ...
    { id: 'trocanter_d', nome: 'Trocânter Maior do Fêmur Direito' },
    { id: 'trocanter_e', nome: 'Trocânter Maior do Fêmur Esquerdo' },
    ...
    { id: 'halux_d', nome: 'Hálux Direito (ponta do pé)' },
    { id: 'halux_e', nome: 'Hálux Esquerdo (ponta do pé)' },
  ],
  posterior: [
    { id: 'trago_d', nome: 'Trago Direito' },
    { id: 'trago_e', nome: 'Trago Esquerdo' },
    ...
    { id: 'escapula_d', nome: 'Ângulo Inferior da Escápula Direita' },
    { id: 'escapula_e', nome: 'Ângulo Inferior da Escápula Esquerda' },
  ...
  lateral_direita: [
    ...
    { id: 'eias', nome: 'Espinha Ilíaca Ântero-Superior' },
    { id: 'eips', nome: 'Espinha Ilíaca Póstero-Superior' },
