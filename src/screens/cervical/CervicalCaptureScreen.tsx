  ...
  if (!permission.granted) {
    return (
      <View style={styles.container}>
        <Text style={styles.text}>Precisamos de acesso à câmera para a análise cervical.</Text>
      ...
      <CameraView style={styles.camera} ref={cameraRef}>
        <View style={styles.overlay}>
          <View style={styles.header}>
            <Text style={styles.headerText}>Posicione de perfil (lateral)</Text>
          </View>
          <View style={styles.guideBox}>
            <Text style={styles.guideText}>Enquadre cabeça e ombro</Text>
          </View>
