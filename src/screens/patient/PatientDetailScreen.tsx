...
const styles = StyleSheet.create({
  ...
  btnPdf: { backgroundColor: '#22C55E', marginHorizontal: 20, marginBottom: 16, paddingVertical: 11, borderRadius: 12, alignItems: 'center' },
  btnPdfText: { color: '#FFFFFF', fontWeight: 'bold', fontSize: 14 },
